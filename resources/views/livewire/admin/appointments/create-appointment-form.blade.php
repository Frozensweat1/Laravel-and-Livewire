<div>
  ...
  <div class="card card-primary">
            ...
            <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div wire:ignore class="form-group">
                        <label>Note:</label>
                        <textarea id="note" data-note="@this" wire:model.defer="state.note" class="form-control" rows="3" placeholder="Enter note here ..."></textarea>
                      </div>
                    </div>
          ...
          <button type="reset" class="btn btn-danger mr-2"><i class="fas fa-times mr-2"></i> Cancel</button> 
           <button type="submit" id="save" class="btn btn-primary mr-1"><i class="fas fa-save mr-2"></i> Save</button>
          </div>
        </div>
        </form>
        <!-- /.card -->
